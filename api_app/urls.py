...
urlpatterns = [
    ...
    path('editorales/actualizar/<int:pk>/', ActualizarEditorial.as_view(), name='actualizar-editorial'),
    path('editorales/eliminar/<int:pk>/', EliminarEditorial.as_view(), name='eliminar-editorial'),
    ...
    path('prestamos/fecha/<str:FechaPrestamo>/', pertamobyfecha.as_view(), name='prestamo-por-fecha'),
    path('prestamos/miembro/<str:Nombre>/',prestamobymiembro.as_view(), name='prestamo-por-miembro')
]